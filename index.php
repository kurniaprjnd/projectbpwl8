...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			<h1 class="animated fadeInDown delay-07s">Welcome To MUSIC World</h1>
				...
				<div class="col-lg-4 col-sm-6 wow fadeInLeft delay-05s">
					<div class="service-list">
						...
						<div class="service-list-col2">
							<h3>Aerophone</h3>
							<p>Alat musik dimana sumber bunyinya berasal dari udara yang bergetar dengan cara ditiup atau dipompa.</div>
					</div>
					<div class="service-list">
						<div class="service-list-col1">
							<img src="img/idio.png"></img>
						</div>
						<div class="service-list-col2">
							<h3>Idiophone</h3>
							<p>Alat musik dimana sumber bunyinya berasal dari batangan logam atau kayu yang dipukul atau sumber bunyinya berasal dari alat itu sendiri.</p>
						</div>
					</div>
					<div class="service-list">
						<div class="service-list-col1">
							<img src="img/elektro.png"></img>
						</div>
						<div class="service-list-col2">
							<h3>Elektrophone</h3>
							<p>Alat musik dimana sumber bunyinya berasal dari rangkaian elektronika yang terdapat di dalam alat tersebut. Perkembangan teknologi saat ini membuat alat ini bisa mengeluarkankan suara dari berbgai jenis alat musik.</p>
						</div>
					</div>
					<div class="service-list">
						<div class="service-list-col1">
							<img src="img/membran.png"></img>
						</div>
						<div class="service-list-col2">
							<h3>Membranophone</h3>
							<p>Alat musik dimana sumber bunyinya bersumber pada getaran pada selaput tipis yang terbuat dari kulit atau plastik yang berbunyi dengan cara dipukul.</p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-7 col-sm-8 featured-work">
					<h2>Genre Musik Populer</h2>
					<P class="padding-b">Musik populer memiliki banyak jenis atau biasa disebut dengan genre. Jenis musik tersebut memiliki perbedaan dan ciri-ciri membuat kamu yang mendengarkannya sudah dapat menebak jenis musik apa itu.Berikut jenis musik yang populer dikalangan masyarakat :<div class="featured-box">
						<div class="featured-box-col1 wow fadeInRight delay-02s">
							<i class="fa fa-magic"></i>
						</div>
						<div class="featured-box-col2 wow fadeInRight delay-02s">
							<h3>Jazz</h3>
							<p>Musik jazz pertama muncul dari negara Amerika di mana menggabungkan berbagai alat musik yang menghasilkan bunyi yang baru. Musik jazz biasanya banyak disukai oleh kalangan-kalangan tertentu. Jenis muik ini memang sarat akan nilai elegan dan berkelas.</p>
						</div>
					</div>
					<div class="featured-box">
						...
						<div class="featured-box-col2 wow fadeInRight delay-04s">
							<h3>Rock</h3>
							<p>Menjadi salah satu jenis musik yang terus berkembang, musik rock memang disukai oleh banyak kalangan. Musik ini menyelimuti pergabungan aneka jenis musik dan mulai dikenal oleh dunia pada tahun 1940-an.</p>
						</div>
					</div>
					<div class="featured-box">
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					<div class="contact-info-box address clearfix">
						...
						<span>Jalan Umbansari <br>Pekanbaru, Riau</span>
					</div>
					<div class="contact-info-box phone clearfix">
						<h3><i class="fa fa-phone"></i>Phone:</h3>
						<span>0812-7571-1234</span>
					</div>
					<div class="contact-info-box email clearfix">
						<h3><i class="fa fa-pencil"></i>Email:</h3>
						<span>musicworld@pcr.com</span>
					</div>
	...
	<footer class="footer">
		<div class="container">
			...
			<span class="copyright">&copy; Music World - Politeknik Caltex Riau</span>
